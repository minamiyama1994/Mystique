...
namespace Inscribe.Helpers
{
    public static class TwitterRegexPatterns
    {
        ...
        private const string UrlValidPreceeding = "(?:[^A-Z0-9@Åó$#Åî\u202A-\u202E]|^)";
        ...
        **/
        ...
        public static readonly Regex InvalidHashtagMatchEnd = new Regex("^(?:[#Åî]|://)", RegexOptions.Compiled);
        ...
        public static readonly Regex ValidReply = new Regex("^(?:" + UnicodeSpaces + ")*" + AtSigns + "([a-z0-9_]{1,20})", RegexOptions.IgnoreCase | RegexOptions.Compiled);
        ...
        public static readonly Regex ValidCashtag = new Regex("(^|" + UnicodeSpaces + ")(" + DollarSignChar + ")(" + Cashtag + ")" + "(?=$|\\s|[" + PunctChars + "])", RegexOptions.IgnoreCase | RegexOptions.Compiled);
